<div class="product-details-accordion" id="product_details_accordion">
    <div class="accordion-item">
        <div class="accordion-header" id="panelsStayOpen-headingOne">
            ...
            <i id="product_details_toggle_details_icon" class="fa fa-plus" data-bs-toggle="collapse"
        ...
        <div id="panelsStayOpen-collapseOne" class="accordion-collapse collapse show"
            ...
            <div class="accordion-body">
                <div class="long-description">
                    Made with our sheer and gauzy Endless Summer fabric, this flowy and effortless maxi dress
                    featuring a halter neckline with adjustable ties at the back creating skin baring cutout
                    details. Layered design with dramatic slits.
                </div>
    ...
    <div class="accordion-item">
        <h2 class="accordion-header" id="panelsStayOpen-headingTwo">
            <button id="product_details_toggle_contents_button" class="accordion-button collapsed" type="button"
                data-bs-toggle="collapse" data-bs-target="#panelsStayOpen-collapseTwo" aria-expanded="false"
                aria-controls="panelsStayOpen-collapseTwo">
                Contents
            </button>
            <i id="product_details_toggle_contents_icon" class="fa fa-minus" data-bs-toggle="collapse"
    ...
    <div class="accordion-item">
        <h2 class="accordion-header" id="panelsStayOpen-headingThree">
            <button id="product_details_toggle_return_button" class="accordion-button collapsed" type="button"
                data-bs-toggle="collapse" data-bs-target="#panelsStayOpen-collapseThree" aria-expanded="false"
                aria-controls="panelsStayOpen-collapseThree">
                Shipping , Return
            </button>
            <i id="product_details_toggle_return_icon" class="fa fa-minus" data-bs-toggle="collapse"
